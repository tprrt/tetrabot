...
Robot_Tetra::Robot_Tetra(btDynamicsWorld* world,Ogre::SceneManager * scene,btVector3& posInit)
{
	Piston* pistonTMP;
	Noeud* bouleTMP;
...
Robot_Tetra::Robot_Tetra(btDynamicsWorld* world,btVector3& posInit)
{
	Noeud* bouleTMP;
	Piston* pistonTMP;
	// le vecteur decalage sert à espacer les objets
