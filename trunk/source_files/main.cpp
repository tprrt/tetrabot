...
{
	GL_Piston* PistonDemo = new GL_Piston();

        PistonDemo->initPhysics();
		PistonDemo->getDynamicsWorld()->setDebugDrawer(&gDebugDrawer);
		PistonDemo->setDebugMode(btIDebugDraw::DBG_DrawConstraints+btIDebugDraw::DBG_DrawConstraintLimits);
       
        return glutmain(argc, argv,640,480,"Piston Demo (test).", PistonDemo);
