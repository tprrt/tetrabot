...
void TetraRendering::createScene() {
	...
	this->pSceneManager->getSceneNode("NodeNoeud1")->scale(3.5, 3.5, 3.5);
	this->pSceneManager->getSceneNode("NodeNoeud1")->setPosition(Ogre::Vector3(750, 250, 750));
	...
	this->pSceneManager->getSceneNode("NodeNoeud2")->scale(3.5, 3.5, 3.5);
	...
	this->pSceneManager->getSceneNode("NodeNoeud3")->scale(3.5, 3.5, 3.5);
	...
	this->pSceneManager->getSceneNode("NodeNoeud4")->scale(3.5, 3.5, 3.5);
	...
	this->robotPhysic = new Robot_Tetra(Monde,this->pSceneManager,btVector3(750,250,750));
